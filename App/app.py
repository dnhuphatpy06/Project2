...
Button(option, text='Ghi âm', width=30, command=record_dai).grid(row=0, column=1, padx=10)
...
du_doan_don.grid(row=5, column=0, pady=5)
### 6
Label(root, text='Dự đoán:',fg='red', font=('cambria', 16), width=40).grid(row=6,column=0,pady=10)
### 7
progress_bar = Progressbar(root, orient="horizontal", length=300, mode="indeterminate")
progress_bar.grid_forget()
hang_7 = Frame(root)
hien_chu_hang_7 = Label(hang_7, text='')
hang_7.grid(row=7, column=0, pady=5)
### 7
dudoan = Frame(root)
anh = Label(dudoan)
